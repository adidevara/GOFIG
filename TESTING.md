...
After installing and loading the following, the script should have all of the necessary 
...
Using the out.csv file which is the output of the ontComp() function, the ontVennSub() function can be executed through typing the following: 
 ...
 The outputs of this function will be saved as a three PNG file to the working directory, one for cellular component, one for molecular function, one for biological processes. 
